...
#endif //CIMGUI_DEFINE_ENUMS_AND_STRUCTS
CIMGUI_API ImPlotPoint* ImPlotPoint_ImPlotPoint(void);
...
CIMGUI_API ImPlotRect* ImPlotRect_ImPlotRect(void);
...
CIMGUI_API ImPlotDateTimeSpec* ImPlotDateTimeSpec_ImPlotDateTimeSpec(void);
...
CIMGUI_API ImPlotTime* ImPlotTime_ImPlotTime(void);
...
CIMGUI_API ImPlotAxis* ImPlotPlot_XAxis(ImPlotPlot* self,int i);
CIMGUI_API const ImPlotAxis* ImPlotPlot_XAxis__const(ImPlotPlot* self,int i);
CIMGUI_API ImPlotAxis* ImPlotPlot_YAxis(ImPlotPlot* self,int i);
