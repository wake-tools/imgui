...
{
return  ImGui::CalcWindowNextAutoFitSize(window);
}
...
{
return  ImGui::WindowRectAbsToRel(window,r);
}
CIMGUI_API ImRect igWindowRectRelToAbs(ImGuiWindow* window,const ImRect r)
{
return  ImGui::WindowRectRelToAbs(window,r);
}
...
CIMGUI_API void igMarkIniSettingsDirty()
{
...
{
return  ImGui::ScrollToRectEx(window,rect,flags);
}
...
CIMGUI_API ImVec2 igGetContentRegionMaxAbs()
{
return  ImGui::GetContentRegionMaxAbs();
}
...
{
return  ImGui::GetPopupAllowedExtentRect(window);
}
...
{
return  ImGui::FindBestWindowPosForPopup(window);
}
...
{
return  ImGui::FindBestWindowPosForPopupEx(ref_pos,size,last_dir,r_outer,r_avoid,policy);
}
...
{
return  ImGui::GetKeyVector2d(key_left,key_right,key_up,key_down);
}
...
{
return  ImGui::TableGetCellBgRect(table,column_n);
}
...
{
return  ImGui::TabItemCalcSize(label,has_close_button_or_unsaved_marker);
}
CIMGUI_API ImVec2 igTabItemCalcSize_WindowPtr(ImGuiWindow* window)
{
return  ImGui::TabItemCalcSize(window);
}
